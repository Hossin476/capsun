...
const mainNews = {
  title:
    "Innovative Battery Technology Revolutionizes Renewable Energy Storage",
  subtitle:
    "New advancements promise longer-lasting and more efficient energy solutions",
  date: "2024-10-04",
...
function News() {
  return (
    <section className="w-full mx-auto text-white p-10 font-inter" id="news">
      <h2 className="text-3xl font-bold text-white mb-10 leading-7">
        Latest News
      </h2>
      <div className="flex flex-col lg:flex-row gap-6">
        <div className="lg:w-4/5 relative overflow-hidden rounded-lg shadow-lg">
          ...
          <div className="absolute inset-0 flex flex-col justify-end p-6 text-white">
            ...
            <div className="flex justify-between items-center">
              <a className="bg-white text-black cursor-pointer px-4 py-2 rounded-md text-sm font-medium hover:bg-opacity-90 transition-colors">
                Read More
              </a>
        ...
        <div className="lg:w-1/5 space-y-6">
          {otherNews.map((news, index) => (
            ...
            >
              <div className="p-4">
                <h4 className="mb-2 line-clamp-2 text-black">{news.title}</h4>
                <div className="flex justify-between items-center">
